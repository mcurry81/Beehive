  ...
  <div class="row" id="recordHeading">
    ...
    <br>
     ...
     <center><strong> <h5>With your help, we hope to gather enough data to help save the honeybees...than you!</h5></strong></center>
      <a href="http://beetest.greenrivertech.net/views/chart.php" id="showGraph"><strong>Click to See Graph</strong></a> <br>
    <!--<button class="beeBtn" name="action" id="add" type="submit" value="add"
    action="?action=add">Add Samples</button>  -->   
      </div><!--end of row-->            
